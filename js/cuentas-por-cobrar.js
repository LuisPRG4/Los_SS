...
<head>
    ...
    <link rel="stylesheet" href="css/morosos.css">
    <link rel="stylesheet" href="css/ayuda.css" />
    <link rel="stylesheet" href="css/calendar.css" />
    <link rel="stylesheet" href="css/whatsapp.css" />
    <link rel="stylesheet" href="css/modal-productos.css" />
    ...
    <link rel="stylesheet" href="css/dashboard-cpc.css">
    <link rel="stylesheet" href="css/logo.css"/>
    <link rel="stylesheet" href="css/tarjeta-consolidada.css"/>
...
<body>
    ...
    <header class="header-elegante">
        <div class="header-container">
            ...
            <span class="connection-icon online" title="En línea">●</span>
        </div>
    </header>
  ...
  <div id="main-content-wrapper" class="main-content">
    <nav class="top-nav-bar-mobile">
        <div class="menu-toggle-mobile" onclick="toggleMenu()">☰</div> <div class="nav-title-mobile"></div>
    </nav>
    ...
    <main>
        ...
        <section class="filtro-seccion">
            ...
            <div class="filtros-container">
                ...
                <div class="form-group">
                    <label for="filtroClienteBusquedaDinamica">Buscar por Cliente (Dinámico):</label>
                    <div class="autocomplete-container">
                        <input type="text" id="filtroClienteBusquedaDinamica" class="form-control" placeholder="Escribe el nombre del cliente..." autocomplete="off" list="clientesLista">
                    <datalist id="clientesLista"></datalist>
                    <ul id="sugerenciasClientes" class="autocomplete-suggestions"></ul>
                    </div>
                </div>
        ...
        <section id="rankingMorosos" style="margin-top: 20px;">
            <h2>🚨 Clientes con Vencimientos Urgentes</h2>

             <!-- ✅ Selector dinámico -->
            <div class="form-group" style="margin-top: 10px;">
                <label for="selectorDiasUrgentes">Mostrar clientes con vencimiento en los próximos:</label>
                <select id="selectorDiasUrgentes" class="form-control" style="width: 80px; display: inline-block;">
        ...
        <section class="dashboard-cxc-nueva">
        <h2>📊 Resumen Financiero Pendiente</h2>
        <div class="dashboard-cards-container">
            <div class="dashboard-card-nueva">
                <h3>Total Pendiente</h3>
                <p id="totalPendienteDashboard">$0.00</p>
            </div>
            <div class="dashboard-card-nueva">
                <h3>Cuentas Pendientes</h3>
                <p id="ventasPendientesDashboard">0</p>
            </div>
            <div class="dashboard-card-nueva">
                <h3>Vencidas</h3>
                <p id="ventasVencidasDashboard">$0.00</p>
            </div>
            <div class="dashboard-card-nueva">
                <h3>Por Vencer</h3>
                <p id="porVencerDashboard">$0.00</p>
            </div>
        </div>
    </section>

        <section class="kpi-box" id="kpiBoxAntiguo">
   ...
   <!-- Mini menú lateral con botón de flechita -->
    <div id="miniMenuLateral" class="retraido">
        ...
        <button id="btnReporteProductos" class="miniBoton dorado" title="Ver Reporte de Productos">📋</button>
  ...
  <div id="respuestaChatbot" style="margin-top: 10px;"></div>
    ...
    <div id="modalAbono" class="modal-overlay" style="display: none;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="btnCancelarEdicionAbono" class="btn btn-secondary" style="display: none;">Cancelar Edición</button>
                <button type="button" onclick="cerrarModalAbono()" class="btn-secondary">Cerrar</button>
            </div>
        </div>
    </div>
    ...
    <script src="js/chatbot-voz.js"></script>
    <script src="js/modal-productos.js"></script>
    <script src="js/connection-status.js"></script>

    <!-- Modal de Detalle de Venta -->
    <div id="modalDetalleVenta" class="modal-overlay" style="display: none;">
        <div class="modal-content">
            <div class="modal-header">
                <h2 id="modalDetalleVentaTitulo">Detalle de Venta</h2>
                <span class="close-button" id="cerrarModalDetalleVenta">&times;</span>
            </div>
            <div class="modal-body">
                <div id="contenidoModalDetalleVenta">
                    <!-- Aquí se cargará dinámicamente el contenido de la tarjeta de venta -->
                </div>
                <div class="modal-actions mt-4">
                    <h3>Acciones:</h3>
                    <button id="btnAbrirModalAbonoDesdeDetalle" class="btn-primary mb-2">Registrar Abono</button>
                    <button id="btnVerHistorialPagosDesdeDetalle" class="btn-secondary mb-2">Ver Historial de Pagos</button>
                    <button id="btnEditarVentaDesdeDetalle" class="btn-info mb-2">Editar Venta</button>
                    <div class="whatsapp-dropdown-container">
                        <button class="btn-whatsapp dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fab fa-whatsapp"></i> Enviar WhatsApp
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item" href="#" id="btnWhatsappPrincipal">Contactar por WhatsApp</a></li>
                            <li><a class="dropdown-item" href="#" id="btnWhatsappAlternativo">Btn. José Luis</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        // Redirección si la sesión no está iniciada (se mantiene aquí para seguridad)
     ...
     <!--Script para el modal de inventario en todos los módulos-->
   <div id="modalReporteProductos" class="modal">
    <div class="modal-contenido">
        <span class="cerrar-modal">&times;</span>
        <h2>📋 Reporte de Productos</h2>
        <div id="reporteVistasContainer">
            <div id="listaReporteProductos" class="reporte-lista">
                </div>
            <div id="tablaReporteProductos" class="reporte-tabla" style="display: none;">
                <table>
                    <thead>
                        <tr>
                            <th>Nombre</th>
        ...
        <button id="btnCambiarVista" class="btn-cambiar-vista">Cambiar a Vista de Tabla</button>
    </div>
</div>
